        ...
        for (int x = 0; x < dimensaoTabuleiro.width; x++) {
            for (int y = 0; y < dimensaoTabuleiro.height; y++) {
                ...
                if (tabuleiro[x][y]) {
                     ...
                     * suficientes
                     */
                    if (vizinhosVivos >= 4 && vizinhosVivos < 7) {
                        // pintará o local com célula viva
                     ...
                     * vizinhos vivos for maior que 6, na próxima iteração a
                     * célula morre por super população
                     * Portanto o crescimento populacional aumenta o uso de pesticidas para preservar o alimento, aquecimento global e destruição do habitat natural dos bichinhos.
                     */
                } else {
                    /**
                     ...
                     */
                    if (vizinhosVivos == 4 || vizinhosVivos == 6) {
                        celulasVivas.add(new Point(x, y));
                    }
                }// Fim do else
            }// Fim do for j
